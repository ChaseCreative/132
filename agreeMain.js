...
function get(x){
  ...
  //CHANGE THE NAMES OF THE GAMES HERE
    var game1Title = get("answerOne").innerHTML = "Let's Do 1-3-2!";
...
function appName() {get("boxTwo").innerHTML = "132";}

function gameTitle() {get("startButton").innerHTML = "Let's Get 1-3-2 It!";}
...
function answerSetup(){
 ...
 function selectGame1(){
 	...
 	startButton.disabled = false;
 	startButton.onclick = function(){mixUpFun()};
